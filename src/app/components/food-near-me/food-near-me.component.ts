...
@Component({
  selector: 'app-food-near-me',
  templateUrl: './food-near-me.component.html',
  styleUrls: ['./food-near-me.component.css']
})
export class FoodNearMeComponent implements OnInit {
